...
; Characteristics of each move.
	...
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        55, NORMAL,       100, 25
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        85, 10
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, DRAGON,        85, 15
	...
	move SCRATCH,      RECOIL_EFFECT,     	        40, NORMAL,       100, 35
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        45, NORMAL,       100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   CHARGE_EFFECT,               60, NORMAL,        70, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        50, NORMAL,        95, 20
	move GUST,         NO_ADDITIONAL_EFFECT,        40, FLYING,       100, 35
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        50, FLYING,       100, 35
	move WHIRLWIND,    SPLASH_EFFECT, 	         0, NORMAL,       100, 20
	move FLY,          FLY_EFFECT,                 100, FLYING,       100, 15
	move BIND,         TRAPPING_EFFECT,             15, NORMAL,        75, 20
	move SLAM,         NO_ADDITIONAL_EFFECT,        80, NORMAL,        75, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        35, GRASS,        100,  5
	...
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,       120, BUG,           85,  5
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        85, 20
	move HORN_DRILL,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move TACKLE,       RECOIL_EFFECT,    	        35, NORMAL,        95, 35
	...
	move TWINEEDLE,    TWINEEDLE_EFFECT,            10, BUG,          100, 20
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, BUG,           85, 20
	move LEER,         DEFENSE_DOWN1_EFFECT,         0, NORMAL,       100, 30
	move BITE,         RECOIL_EFFECT,               60, NORMAL,       100, 25
	move GROWL,        ATTACK_DOWN1_EFFECT,          0, NORMAL,       100, 40
	move ROAR,         SPLASH_EFFECT,		 0, NORMAL,       100, 20
	...
	move EMBER,        BURN_SIDE_EFFECT1,           30, FIRE,         100, 25
	...
	move PSYBEAM,      CONFUSION_SIDE_EFFECT,       95, PSYCHIC_TYPE, 100, 20
	move BUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      65, WATER,        100, 20
	move AURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,     65, ICE,          100, 20
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL,        90,  5
	move PECK,         NO_ADDITIONAL_EFFECT,        35, FLYING,       100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, FLYING,       100, 20
	move SUBMISSION,   RECOIL_EFFECT,               70, FIGHTING,      80, 25
	...
	move ABSORB,       DRAIN_HP_EFFECT,             15, GRASS,        100, 20
	...
	move DRAGON_RAGE,  SPECIAL_DAMAGE_EFFECT,        1, FLYING,       100, 10
	...
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        50, ROCK,          60, 15
	move EARTHQUAKE,   NO_ADDITIONAL_EFFECT,       100, GROUND,       100, 10
	move FISSURE,      OHKO_EFFECT,                  1, GROUND,        30,  5
	move DIG,          CHARGE_EFFECT,              120, GROUND,       100, 10
	...
	move TELEPORT,     SPLASH_EFFECT,	         0, PSYCHIC_TYPE, 100, 20
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        0, GHOST,        100, 15
	move MIMIC,        MIMIC_EFFECT,                 0, NORMAL,       100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,        95, 40
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, NORMAL,       100, 15
	move RECOVER,      HEAL_EFFECT,                  0, NORMAL,        90, 20
	...
	move LICK,         NO_ADDITIONAL_EFFECT,        80, GHOST,        100, 30
	move SMOG,         POISON_SIDE_EFFECT2,         20, POISON,        70, 20
	move SLUDGE,       POISON_SIDE_EFFECT2,         60, POISON,        90, 20
	...
	move SOFTBOILED,   HEAL_EFFECT,                  0, NORMAL,        90, 10
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           140, FIGHTING,      90, 20
	...
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             15, BUG,          100, 15
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,        75, 10
	move SKY_ATTACK,   CHARGE_EFFECT,              140, FLYING,        90,  5
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      20, WATER,        100, 30
	move DIZZY_PUNCH,  BURN_SIDE_EFFECT1,           70, NORMAL,       100, 10
	...
	move CRABHAMMER,   RECOIL_EFFECT,    	       190, WATER,         85, 10
	...
	move TRI_ATTACK,   SPEED_DOWN_SIDE_EFFECT,      80, NORMAL,       100, 10
	move SUPER_FANG,   SUPER_FANG_EFFECT,            1, NORMAL,        90, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,        85, NORMAL,       100, 20
