...
; Route 8
	...
	db 22, CLEFAIRY, CLEFAIRY, CLEFAIRY, CLEFAIRY, 0
; Celadon Gym
...
; Cinnabar Gym
	db 36, VULPIX, VULPIX, NINETALES, ELECTRODE, 0
...
; Jessie & James
	...
	db 31, WEEZING, ARBOK, MEOWTH, VICTREEBEL, 0 ; Silph Co. 11F
; Unused
	db 16, KOFFING, 0
	db 27, KOFFING, 0
	db 29, WEEZING, 0
...
AgathaData:
	db $FF, 56, GENGAR, 56, GENGAR, 55, GENGAR, 58, GENGAR, 60, GENGAR, 0
